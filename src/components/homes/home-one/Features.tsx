                     ...
                     <div className="row justify-content-between">
                        <div className="col-lg-8">
                           <div className="section-title mb-35">
                              <span className="section-title__subtitle mb-10">Our Core Focus</span>
                              <h2>Empowering <span>Women in Christ</span></h2>
                              <p>Explore how you can support The Pride of a Woman’s mission—whether through giving, volunteering, or joining our spiritual and educational outreaches.</p>
                           </div>
                        </div>
                     </div>
